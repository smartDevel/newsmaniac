package eu.ways4.newsmaniac.ui.category.general;
...
public class GeneralAdapter extends ListAdapter<Article, GeneralAdapter.GeneralViewHolder> {

    HeadlineListItemBinding binding;
    Activity activity;

    public GeneralAdapter(Activity activity) {
    ...
    class GeneralViewHolder extends RecyclerView.ViewHolder {
        ...
        public GeneralViewHolder(HeadlineListItemBinding binding) {
