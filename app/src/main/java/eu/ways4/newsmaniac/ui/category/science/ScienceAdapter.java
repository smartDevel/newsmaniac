package eu.ways4.newsmaniac.ui.category.science;
...
public class ScienceAdapter extends ListAdapter<Article, ScienceAdapter.ScienceViewHolder> {

    HeadlineListItemBinding binding;
    Activity activity;

    public ScienceAdapter(Activity activity) {
    ...
    public ScienceAdapter.ScienceViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ScienceAdapter.ScienceViewHolder(binding);
    }

    @Override
    public void onBindViewHolder(@NonNull ScienceAdapter.ScienceViewHolder holder, int position) {
    ...
    class ScienceViewHolder extends RecyclerView.ViewHolder {
        ...
        public ScienceViewHolder(HeadlineListItemBinding binding) {
